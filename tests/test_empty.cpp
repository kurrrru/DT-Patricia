...
static std::vector<TestCase> make_testcases(void) {
    ...
    testcases.push_back({
        "Target has a single empty string, query also has a single empty string",
        "DnaAlphabet",
        "UnitCost",
        1, 1, 1,
        {""},  // targets
    ...
    testcases.push_back({
        "Target has three empty strings, query also has a single empty string",
        "DnaAlphabet",
        "UnitCost",
        1, 1, 1,
        {"", "", ""},  // targets
    ...
    testcases.push_back({
        "Target has two empty strings and one non-empty string, query also has a single empty string",
        "DnaAlphabet",
        "UnitCost",
        1, 1, 1,
        {"", "", "a"},  // targets
